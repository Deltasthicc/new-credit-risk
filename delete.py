...
endpoint = "https://bureausearchsvc.search.windows.net"  # The endpoint URL for your Azure Search service
key = "U9XMLkaUoJ1z8AN7aMRAUMhYmNNLlyhNJTM1c1mof1AzSeCPowx9"  # Admin API key for authentication (keep this secure!)
index_name = "bureau-index-v3"  # The name of the index you want to delete
